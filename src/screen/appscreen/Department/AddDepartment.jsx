...
import { createDepartmentAction, registerPatientAction } from '../../../reduxtool/app/middleware';
import { createDepartmentAsync } from '../../../reduxtool/app/service';
...
const AddDepartment = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(createDepartmentAction(payload))
